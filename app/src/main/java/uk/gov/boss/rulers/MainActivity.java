...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (selectedView != null) {
                //default England
                mArrayAdapter = new customAdapter(selectedView);
                mainListView.setAdapter(mArrayAdapter);
            }
        }
        else {
            //default England
            mArrayAdapter = new customAdapter("england");
            mainListView.setAdapter(mArrayAdapter);
        }
    }
    ...
    private void setShareIntent() {
        if (mShareActionProvider != null) {
            ...
            shareIntent.putExtra(Intent.EXTRA_SUBJECT, "The Rulers app is quite nice");
            shareIntent.putExtra(Intent.EXTRA_TEXT, "The Rulers app is reasonably good");
    ...
    public class customAdapter extends BaseAdapter {
        ...
        public customAdapter(String filter) {
            //with parameters
        ...
        @Override
        public customListItem getItem(int arg0) {
            return customList.get(arg0);
        }
